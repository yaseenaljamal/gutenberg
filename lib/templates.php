...
function gutenberg_create_template_auto_drafts_on_shutdown() {
	if ( ! gutenberg_is_block_editor() ) {
		return;
	}

	gutenberg_create_template_auto_drafts();
}
register_shutdown_function( 'gutenberg_create_template_auto_drafts_on_shutdown' );
